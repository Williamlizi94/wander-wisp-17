...
export const WORLD_CITY_DATA: RegionData[] = [
  ...
  },
  {
    ...
    countries: [
      { country: "美国", cities: [
        "纽约", "洛杉矶", "旧金山", "拉斯维加斯", "夏威夷", "华盛顿", "芝加哥", "迈阿密",
        "西雅图", "波士顿", "奥兰多", "圣地亚哥", "黄石公园", "大峡谷", "休斯顿", "达拉斯",
        "丹佛", "费城", "菲尼克斯", "波特兰", "纳什维尔", "新奥尔良", "亚特兰大", "底特律",
        "盐湖城", "圣安东尼奥", "匹兹堡", "明尼阿波利斯", "堪萨斯城", "奥斯汀",
        "优胜美地", "羚羊谷", "纪念碑谷", "拱门国家公园", "锡安国家公园", "冰川国家公园",
        "大提顿国家公园", "红杉国家公园", "阿卡迪亚国家公园", "落基山国家公园",
        "尼亚加拉瀑布", "阿拉斯加", "关岛", "塞班岛", "棕榈泉", "纳帕谷",
        "查尔斯顿", "萨凡纳", "圣塔菲", "基韦斯特", "马尔代夫海滩",
        "一号公路", "66号公路"
      ] },
